...
public class Empleado extends Persona{
    ...
    public DefaultTableModel leer(){
        ...
        try{
            ...
            cn= new Conexion();
            cn.abrir_conexion();
            String query="SELECT e.id_empleado as id,e.codigo,e.nombres,e.apellidos,e.direccion,e.telefono,e.fecha_nacimiento";
...
datos[6]=consulta.getString("decha_nacimiento");
